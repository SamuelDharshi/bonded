...
const layers = [
  { label: "PROPOSAL 0x8f…c2", color: "#FFD600", indent: 0, active: true },
  { label: "AGENT", color: "#888", indent: 12 },
  { label: "ACTION / SWAP", color: "#60A5FA", indent: 12 },
  { label: "VALUE 250 USDC", color: "#888", indent: 24 },
  { label: "PREMISES [2]", color: "#FF6B35", indent: 12 },
  { label: "TVL — CLAIMED", color: "#FF6B35", indent: 24 },
  { label: "POOL_AGE — CLAIMED", color: "#FF6B35", indent: 24 },
  { label: "RE-DERIVED @ BLOCK", color: "#4ADE80", indent: 12 },
  { label: "VERDICT", color: "#888", indent: 0 },
];

const inspectProps = [
  { key: "OUTCOME", val: "REFUSED", swatch: "#FF6B35" },
  { key: "REASON", val: "PREMISE_MISMATCH" },
  { key: "CODE", val: "1" },
  { key: "BLOCK", val: "61234114" },
  { key: "CLAIMED", val: "412.0M" },
  { key: "DERIVED", val: "0.00", swatch: "#FF6B35" },
  { key: "TOLERANCE", val: "200 BPS" },
  { key: "SIGNED", val: "NO" },
];

const tokens = [
  { name: "OK", hex: "#4ADE80" },
  { name: "PREMISE_MISMATCH", hex: "#FF6B35" },
  { name: "FORBIDDEN_ACTION", hex: "#FF6B35" },
  { name: "BUDGET_EXCEEDED", hex: "#FFD600" },
  { name: "STALE_POLICY", hex: "#888888" },
];
...
const tickerItems = [
  "PROPOSE", "QUARANTINE", "RE-DERIVE", "COMPARE", "TOLERANCE",
  "BUDGET", "THRESHOLD", "STEP-UP", "SIGN", "SETTLE",
];
  ...
  return (
    <>
      ...
      >
        ...
        <text x="12" y="23" fontFamily="monospace" fontSize="9" fill="#FFD600" letterSpacing={2} fontWeight="700">PROPOSAL</text>
        ...
        <text x="912" y="300" fontFamily="monospace" fontSize="9" fill="#FFD600" letterSpacing={2} fontWeight="700">REASON CODES</text>
        ...
        <text x="280" y="84" fontFamily="monospace" fontSize="8" fill="#FFD600" letterSpacing={1}>ENFORCE() — PINNED @ BLOCK 61234114</text>
        ...
        <text x="330" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>2 PREMISES // 1 REFUSED</text>
