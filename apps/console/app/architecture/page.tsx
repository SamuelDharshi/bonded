...
const LAYERS = [
  ...
  },
  {
    ...
    detail:
      'handlerInTee custodies the enforcer signing key and keeps irreversible_above confidential inside the enclave. Routine verdicts sign without a human; anything above threshold arms a step-up gate.',
  },
  {
    name: 'Settlement',
    sponsor: 'Arc',
